...
# Output the Azure Resources Group ID
...
# Use this data source to access information about an exising Resource Group
...
# Azure virtual Network Block using Terraform Modules(https://registry.terraform.id/modules/Azure/network/azurerm/latest)
